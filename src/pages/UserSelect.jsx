...
function UserSelect() {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center gap-[24px] w-full  mx-auto bg-gray-900 text-white">
              ...
              {customUser && (
                <div className="relative">
                  ...
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="text-yellow-300 w-6 h-6 absolute top-1/2 -translate-y-1/2 right-[-32px] cursor-pointer"
                    onClick={() => {
                      setCustomUser(null);
            ...
            <div className="flex flex-col items-center ">
              ...
              <div className="flex flex-col items-center justify-center w-full mt-3">
                <label
                  ...
                  className="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-800 hover:border-yellow-400 hover:bg-gray-700"
                >
                  <div className="flex flex-col items-center justify-center py-4">
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="w-6 h-6 text-yellow-300 mb-2"
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
