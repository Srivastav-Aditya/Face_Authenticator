...
function Login() {
  ...
  if (imageError) {
    return (
      <div className="dark-bg min-h-screen flex flex-col items-center justify-center gap-[24px] max-w-[840px] mx-auto">
  ...
  return (
    <div className="dark-bg h-full flex flex-col items-center justify-center gap-[24px] max-w-[720px] mx-auto">
      ...
      {localUserStream && loginResult === "FAILED" && (
        <h2 className="text-center text-3xl font-extrabold tracking-tight text-rose-700 sm:text-4xl">
          ...
          <button
            ...
            className="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-600 focus:border-yellow-700 focus:shadow-outline-yellow active:bg-yellow-700 transition ease-in-out duration-150"
          >
            Go back
          </button>
        </h2>
            ...
            {modelsLoaded ? (
              ...
              <>
                <button
                  disabled
                  type="button"
                  className="cursor-not-allowed justify-center  w-full py-2.5 px-5 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-yellow-700 inline-flex items-center"
                >
                  <svg
                    aria-hidden="true"
                    role="status"
